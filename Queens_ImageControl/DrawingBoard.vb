...
Friend Class DrawingBoard
    ...
    'Member Variables
    Private m_MouseButtons As System.Windows.Forms.MouseButtons = MouseButtons.Left
...
#End Region
    ...
    Private Sub Draw_Rectangle(ByVal e As System.Windows.Forms.MouseEventArgs)
        If (New Rectangle(0, 0, Me.Width, Me.Height)).Contains(PointToClient(Cursor.Position)) Then
    ...
    Private Sub ImageViewer_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseMove
        ...
        If e.Button = m_MouseButtons Then
            ...
            If PanMode OrElse (PanMode = False AndAlso IsAltPressed()) Then
    ...
    Public Function IsControlPressed() As Boolean
