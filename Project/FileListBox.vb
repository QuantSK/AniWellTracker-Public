...
Public Class FileListBox
    ...
    Public Property CurrentFullPath() As String
        Get
            Return _CurrentFullPath
        End Get

        Set(value As String)
            _CurrentFullPath = value
        End Set
    End Property


    Public Property ExtFilter() As String
        Get
            Return _ExtFilter
        End Get
    ...
    Public Function FilesCount() As Integer
        ...
        q = ListView.Items.Count

        Return q
    End Function


    Public Function FileName(ByVal FileIndex As Integer) As String
        Dim Buf_Str As String

        If FileIndex >= ListView.Items.Count Then Return ""

        Buf_Str = ListView.Items(FileIndex).SubItems(0).Text
    ...
    Public Sub AdjustWidthRatio(ByVal FirstColumnWidthPercent As Single)
        With ListView
            .Columns(0).Width = CInt((Me.Width - 20) * FirstColumnWidthPercent / 100)
            .Columns(1).Width = CInt((Me.Width - 20) * (100 - FirstColumnWidthPercent) / 100) - 30
        End With
    End Sub
    ...
    Public Sub ReScan()
        ...
        If myFileSys.FolderExists(_CurrentFullPath) = False Or
